...
function addSphere(parent, materials, name, radius, position, scale, materialKey, shadows = {}) {
  const object = createOutlinedMesh(
...
export function createDeskZone({ materials }) {
  ...
  addBox(group, materials, 'desk-top', new THREE.Vector3(6.1, 0.3, 1.3), new THREE.Vector3(-1.2, 1.83, -2.65), 'wood', majorShadow)
  addBox(group, materials, 'desk-apron', new THREE.Vector3(5.7, 0.22, 0.16), new THREE.Vector3(-1.2, 1.57, -2.12), 'wood', { receiveShadow: true })
  addBox(group, materials, 'desk-leg-left', new THREE.Vector3(0.32, 1.68, 1.08), new THREE.Vector3(-4.0, 0.84, -2.65), 'dark', majorShadow)
  addBox(group, materials, 'desk-leg-right', new THREE.Vector3(0.32, 1.68, 1.08), new THREE.Vector3(1.6, 0.84, -2.65), 'dark', majorShadow)
  ...
  addBox(monitor, materials, 'monitor-chin', new THREE.Vector3(1.85, 0.19, 0.16), new THREE.Vector3(0, -0.32, 0.005), 'metal')
  addBox(monitor, materials, 'monitor-neck', new THREE.Vector3(0.17, 0.42, 0.14), new THREE.Vector3(0, -0.68, 0), 'metal')
  addBox(monitor, materials, 'monitor-foot', new THREE.Vector3(0.72, 0.08, 0.42), new THREE.Vector3(0, -0.88, 0.06), 'metal')
  group.add(monitor)

  const keyboard = addBox(group, materials, 'keyboard', new THREE.Vector3(1.55, 0.09, 0.43), new THREE.Vector3(-1.25, 2.04, -2.12), 'paper')
  keyboard.rotation.x = -0.08
  addBox(group, materials, 'desk-notebook', new THREE.Vector3(0.65, 0.08, 0.78), new THREE.Vector3(-2.65, 2.04, -2.52), 'paper')
  ...
  const shade = addSphere(lamp, materials, 'desk-lamp-shade', 0.42, new THREE.Vector3(0, 0.77, 0), new THREE.Vector3(1, 0.55, 1), 'dark', { castShadow: true })
