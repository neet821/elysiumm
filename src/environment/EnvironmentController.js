...
const LIGHT_BY_MODE = Object.freeze({
  dawn: { hemisphere: 1.0, sun: 1.4, sunColor: '#ffd9b0' },
  day: { hemisphere: 1.5, sun: 2.6, sunColor: '#fff2d1' },
  dusk: { hemisphere: 0.85, sun: 1.1, sunColor: '#ffb98a' },
  night: { hemisphere: 0.5, sun: 0.18, sunColor: '#b7c7ff' },
})
