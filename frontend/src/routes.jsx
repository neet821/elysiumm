...
const withUserProps = (Component, styles, isDark, toggleTheme) => (
  <Component styles={styles} isDark={isDark} toggleTheme={toggleTheme} />
);
...
const AppRoutes = ({ styles, isDark, toggleTheme }) => (
  <RouteSuspense>
    <Routes>
    <Route path="/" element={withUserProps(HomePage, styles, isDark, toggleTheme)} />
    <Route path="/login" element={withUserProps(LoginPage, styles, isDark)} />
    <Route path="/register" element={withUserProps(RegisterPage, styles, isDark)} />
    <Route path="/live" element={<LivePage />} />

    <Route path="/archive" element={withUserProps(ArchivePage, styles, isDark)} />
    <Route path="/collection" element={withAuth(withUserProps(CollectionPage, styles, isDark))} />
    <Route path="/books" element={withAuth(<BooksPage />, true)} />

    <Route
      path="/posts/new"
      element={withAuth(withUserProps(PostEditorPage, styles, isDark), true)}
    />
    <Route
      path="/posts/:id/edit"
      element={withAuth(withUserProps(PostEditorPage, styles, isDark), true)}
    />
    <Route path="/posts/:id" element={withUserProps(PostDetailPage, styles, isDark)} />
    ...
    <Route path="/games" element={withAuth(withUserProps(GamesPage, styles, isDark))} />
    <Route path="/games/rooms" element={withAuth(withUserProps(GamesPage, styles, isDark))} />
    <Route path="/games/rooms/:roomId" element={withAuth(withUserProps(GameRoomPage, styles, isDark))} />
    <Route path="/games/:gameId" element={withAuth(withUserProps(GameDetailPage, styles, isDark))} />
    <Route path="/music" element={withAuth(<MusicLobbyPage />)} />
    <Route path="/music/rooms/:roomId" element={withAuth(<MineradioPage />)} />

    <Route path="/tools" element={withUserProps(ToolsPage, styles, isDark)} />

    <Route
      path="/tools/links"
      element={<LegacyRedirect to="/account/admin/content/collection" preserveSearch hash={true} />}
    />
    <Route
      path="/tools/backup"
      element={withAuth(<LegacyRedirect to="/account/admin/backups" preserveSearch hash={true} />, true)}
    />
    <Route
      path="/tools/frp"
      element={withAuth(<LegacyRedirect to="/account/admin/services/frp" preserveSearch hash={true} />, true)}
    />
    <Route
      path="/tools/public-sync"
      element={withAuth(<LegacyRedirect to="/account/admin/files" preserveSearch hash={true} />, true)}
    />
    <Route
      path="/tools/sync-room"
      element={withAuth(withUserProps(SyncRoomList, styles, isDark))}
    />
    <Route
      path="/tools/sync-room/:id"
      element={withAuth(withUserProps(SyncRoomPlayer, styles, isDark))}
    />
    <Route
      path="/account"
      element={withAuth(withUserProps(AccountPage, styles, isDark))}
    />
    <Route
      path="/account/collection"
      element={withAuth(<LegacyRedirect to="/account/admin/content/collection" preserveSearch hash={true} />, true)}
    />
    <Route
      path="/account/admin"
      element={withAuth(<AdminShell />, true)}
    >
      ...
      <Route path="content/photos" element={withUserProps(PhotoManagePage, styles, isDark)} />
      <Route path="users" element={withUserProps(AdminUsersPage, styles, isDark)} />
      <Route path="rooms" element={withUserProps(AdminRoomsPage, styles, isDark)} />
      <Route path="files" element={withUserProps(AdminFilesPage, styles, isDark)} />
      <Route path="services" element={withUserProps(AgentConsolePage, styles, isDark)} />
      <Route path="services/live" element={<AdminLivePage />} />
      <Route path="services/frp" element={withUserProps(FrpAdminPage, styles, isDark)} />
      <Route path="backups" element={withUserProps(BackupPage, styles, isDark)} />
